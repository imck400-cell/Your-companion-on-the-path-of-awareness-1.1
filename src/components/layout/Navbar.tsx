        ...
        <div className="flex items-center gap-4">
          <Link to="/" className="flex flex-col">
            ...
            <div className="flex flex-col -mt-1">
              <span className="text-[10px] md:text-xs text-muted-foreground font-medium">إعداد المستشار الإداري والتربوي إبراهيم دخان</span>
              <a 
                href="https://wa.me/967780804012" 
                target="_blank" 
                rel="noreferrer"
                className="flex items-center gap-1 text-[10px] md:text-xs text-[#25D366] hover:underline font-bold"
              >
